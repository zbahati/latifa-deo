          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <?php
                  $countStudent = "SELECT COUNT(rollnumber) as sum  from student";
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                <?php
                  $countStudent = "SELECT COUNT(rollnumber) as sum  from exam";
                  $query = mysqli_query($conn, $countStudent);
                  while($row = mysqli_fetch_assoc($query)){
                    echo $row['sum'];
                  }
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                <?php
                  $countStudent = "SELECT COUNT(rollnumber) as sum  from claim where `status`= 'Pending'";
                  $query = mysqli_query($conn, $countStudent);
                  while($row = mysqli_fetch_assoc($query)){
                    echo $row['sum'];
                  }
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">
                <?php
                  $countStudent = "SELECT COUNT(user_id) as sum  from user";
                  $query = mysqli_query($conn, $countStudent);
                  while($row = mysqli_fetch_assoc($query)){
                    echo $row['sum'];
                  }
