              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    $select="SELECT * FROM proof_archive where rollnumber= '$userId'";
                    ...
                    while($row=mysqli_fetch_assoc($query)){
                      ...
                      <td>
                        <a href="./claim_form.php?claim=<?php echo $row['proof_id']?>" class="badge badge-btn badge-primary" onclick="return confirm('Do you want to claim?');">Claim</a>
                  </tr>
                  <?php
                    }
                    ?>
